...
def main():
    ...
    if not os.path.isdir('./../images/Nanodiamond_fluorescence_axial'):
        os.mkdir('./../images/Nanodiamond_fluorescence_axial')
...
##    plt.savefig('./../images/Nanodiamond_fluorescence_axial/fluorescence_nd_image_yz.svg')
    ...
    ax1.set_title('B', fontsize=30)
    ax1.axis('off')
    plt.savefig('./../images/Nanodiamond_fluorescence_axial/fluorescence_nd_image_xz.svg')
    plt.show()
