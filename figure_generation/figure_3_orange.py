...
def main():
    ...
    a.add_patch(rect)
    plt.savefig(
        './../images/figure_3/fluorescence_depletion_orange_dye_brightness_optimal.svg')
    plt.show()
    ...
    a.add_patch(rect)
    plt.savefig(
        './../images/figure_3/fluorescence_depletion_orange_dye_brightness_hi.svg')
    plt.show()
    ...
    a.add_patch(rect)
    plt.savefig(
        './../images/figure_3/fluorescence_depletion_orange_dye_brightness_lo.svg')
    plt.show()
