...
def main():
    ...
    plt.xlim(-15, 1465)
    plt.grid()
    plt.savefig('./../images/figure_A6/STE_v_green_power.svg')
    plt.show()
    ...
    plt.xlim(-15, 1465)
    plt.grid()
    plt.savefig('./../images/figure_A6/STE_v_green_power_sparse.svg')
    plt.show()
    ...
    plt.xlim(-3, 303)
    plt.grid()
    plt.savefig('./../images/figure_A6/STE_v_red_power_sparse.svg')
    plt.show()
