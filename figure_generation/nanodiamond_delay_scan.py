...
def main():
    ...
    if not os.path.isdir('./../images/Nanodiamond_delay_scan'):
        os.mkdir('./../images/Nanodiamond_delay_scan')
...
##    data_ctrl = np.zeros((num_delays, height - less_rows * 2, width))
    ...
    plt.axis('off')
    plt.savefig('./../images/Nanodiamond_delay_scan/darkfield_STE_delay_scan.svg',
                bbox_inches='tight')
    plt.show()
    fig = plt.figure()
    ...
    plt.axis('off')
    plt.savefig('./../images/Nanodiamond_delay_scan/darkfield_image.svg',
                bbox_inches='tight')
    plt.show()
