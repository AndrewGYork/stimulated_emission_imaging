...
def main():
    ...
    if not os.path.isdir('./../images/figure_A3'):
        os.mkdir('./../images/figure_A3')
    assert os.path.isdir('./../images')
    ...
    for z_num in range(STE_cropped.shape[0]):
        ...
        ax1.axis('off')
        plt.savefig('./../images/figure_A3/darkfield_STE_image_' +
                    str(z_num)+'.svg')
        plt.close()
    ...
    ax1.set_title('B', fontsize=30)
    ax1.axis('off')
    plt.savefig('./../images/figure_A6/darkfield_STE_image_yz.svg')
    plt.show()
    ...
    ax1.set_title('B', fontsize=30)
    ax1.axis('off')
    plt.savefig('./../images/figure_A6/darkfield_STE_image_xz.svg')
    plt.show()
