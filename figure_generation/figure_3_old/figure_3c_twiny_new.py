...
##    nd_brightness_depleted = depleted_signal[-1,:]
    ...
    ax2 = ax1.twinx()
    ax2.set_yticks(np.round(np.linspace(0,0.8,num=8)*brightness))
    ...
    plt.xticks([])
    plt.yticks([])
    a.text(10,15,'Orange bead',fontsize=14,color='white',fontweight='bold')
    rect = patches.Rectangle(
        (43,29),46,46,linewidth=1,linestyle='dashed',edgecolor='y',facecolor='none')
    a.add_patch(rect)
