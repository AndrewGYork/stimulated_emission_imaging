...
def main():
    ...
    depleted_stack = data[:,:,:,2]/brightness # zero red/green delay
...
##    nd_brightness = fluorescence_signal_mean/brightness
##    nd_brightness_depleted = depleted_signal_mean/brightness
##    nd_brightness_std = fluorescence_signal_std/brightness
##    nd_brightness_depleted_std = depleted_signal_std/brightness
##    nd_brightness_max = fluorescence_signal_max/brightness
##    nd_brightness_depleted_max = depleted_signal_max/brightness
##    nd_brightness_min = fluorescence_signal_min/brightness
##    nd_brightness_depleted_min = depleted_signal_min/brightness
    ...
    ax1.plot(green_powers, model_fl_dep, '-',
             ...
             color='red')
    ax1.fill_between(green_powers, model_fl_dep_max, model_fl_dep_min,
                     color='#FFD0D0')
    plt.ylabel(r'Excitation fraction $n_2$',fontsize=17)
    plt.axis([0,1600,0,0.75])
    ...
    ax2 = ax1.twinx()
    ax2.set_yticks(np.round(np.linspace(0,0.75,num=8)*brightness))
