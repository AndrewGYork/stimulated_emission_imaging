...
##    nd_brightness_depleted = depleted_signal[-1,:]
    ...
    ax1.plot(green_powers, model_fl_dep, '-',
             label=r'Model, $h_{stim}\sigma_{23}=0.18(1/\tau_{fluor})$', color='red')
    ...
    a.add_patch(rect)
    plt.savefig('./../images/figure_3/fluorescence_depletion_dye_rate_optimal.svg')
    plt.show()
...
##    nd_brightness_depleted = depleted_signal[-1,:]
    ...
    ax1.fill_between(green_powers, model_fl_max, model_fl_min,color="#C0FFC0")
    ax1.plot(green_powers, model_fl_dep, '-',
             label=r'Model, $h_{stim}\sigma_{23}=0.15(1/\tau_{fluor})$', color='red')
    ax1.fill_between(green_powers, model_fl_dep_max, model_fl_dep_min,color='#FFD0D0')
    plt.ylabel(r'Excitation fraction $n_2$',fontsize=17)
    plt.axis([0,1600,0,0.7])
    leg = plt.legend(loc='lower right',title='Fluorescence',fontsize=14)
    ...
    rect = patches.Rectangle(
        (43,33),48,46,linewidth=1,linestyle='dashed',edgecolor='y',facecolor='none')
    a.add_patch(rect)
    plt.savefig('./../images/figure_3/fluorescence_depletion_dye_rate_lo.svg')
    plt.show()
...
##    nd_brightness_depleted = depleted_signal[-1,:]
    ...
    ax1.fill_between(green_powers, model_fl_max, model_fl_min,color="#C0FFC0")
    ax1.plot(green_powers, model_fl_dep, '-',
             label=r'Model, $h_{stim}\sigma_{23}=0.21(1/\tau_{fluor})$', color='red')
    ax1.fill_between(green_powers, model_fl_dep_max, model_fl_dep_min,color='#FFD0D0')
    plt.ylabel(r'Excitation fraction $n_2$',fontsize=17)
    plt.axis([0,1600,0,0.7])
    leg = plt.legend(loc='lower right',title='Fluorescence',fontsize=14)
    ...
    rect = patches.Rectangle(
        (43,33),48,46,linewidth=1,linestyle='dashed',edgecolor='y',facecolor='none')
    a.add_patch(rect)
    plt.savefig('./../images/figure_3/fluorescence_depletion_dye_rate_hi.svg')
    plt.show()
