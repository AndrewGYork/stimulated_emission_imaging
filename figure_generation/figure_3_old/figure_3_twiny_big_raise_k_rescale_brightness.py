...
##    np_tif.array_to_tif(darkfield_signal,'darkfield_signal_array.tif')
    ...
    # plot signal
##    mW_per_kex = 950
    mW_per_kex = 930*1.3*1.3
    kex = green_powers / mW_per_kex
    kex_min = 1.1*kex
    kex_max = 0.9*kex

##    mW_per_kdep = 950
    mW_per_kdep = 930*1.3*1.3
    kdep = red_powers[-1] / mW_per_kdep
    kdep_min = 0.6*kdep
    kdep_max = 1.4*kdep

    brightness = 120*1.15*1.15
    model_fl = kex / (1 + kex)
...
##    model_fl_dep_min = kex / (1 + kex + kdep_min)
    ...
    ax1.plot(green_powers,nd_brightness/brightness,'o',
             label='Measured, 0 mW stimulation', color='green')
    ax1.plot(green_powers,nd_brightness_depleted/brightness,'o',
...
##    ax1.plot(green_powers, model_fl_max, color='black')
