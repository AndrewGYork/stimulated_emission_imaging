...
def main():
    ...
    if not os.path.isdir('./../images/figure_S3'):
        os.mkdir('./../images/figure_S3')

    filename = (
        './../../stimulated_emission_data/figure_S3/dataset_green_1500mW.tif')
    filename_ctrl = (
        './../../stimulated_emission_data/figure_S3/dataset_green_0mW.tif')
...
##    np_tif.array_to_tif(phase_stack_ctrl,'phase_ctrl_stack.tif')
    ...
    for angle_num in range(STE_cropped.shape[0]):
        ...
        ax1.axis('off')
        plt.savefig('./../images/figure_S3/phase_STE_image_' +
                    str(angle_num)+'.svg')
        plt.close()
