...
def main():
    ...
    if not os.path.isdir('./../images/Bead_delay_scan'):
        os.mkdir('./../images/Bead_delay_scan')
    ...
    plt.axis('off')
    plt.savefig('./../images/Bead_delay_scan/phase_STE_delay_scan.svg',
                bbox_inches='tight')
    plt.show()
    fig = plt.figure()
    ...
    plt.axis('off')
    plt.savefig('./../images/Bead_delay_scan/phase_image.svg',
                bbox_inches='tight')
    plt.show()
