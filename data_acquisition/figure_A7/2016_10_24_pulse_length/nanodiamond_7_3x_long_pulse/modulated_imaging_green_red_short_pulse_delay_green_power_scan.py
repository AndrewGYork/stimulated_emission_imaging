...
##        '1100mW',
    ...
    red_start_pixel_array = 3*np.array([-2, -1, 0, 1, 2])
    ...
    try:
        ...
        for [voltage_num, my_voltage_mV] in enumerate(green_AOM_mV):


            # Calculate DAQ voltages

            # Set voltages to play on analog out card
            green_voltage = my_voltage_mV/1000
            red_voltage = 0.26
            trig_voltage = 3
            ...
            # loop used to define camera trigger and red laser pulse voltages
            ...
            with open('voltages_green_' + green_powers[voltage_num] +
                      '_red_' + red_power +
            ...
            idp.load_permission_slips(
                ...
                file_saving_info=[
                    {'filename': (
                        ...
                        '_green_' + green_powers[voltage_num] +
                        '_red_' + red_power +
                        '_many_delays.tif'),
                     'channels': num_delays,
