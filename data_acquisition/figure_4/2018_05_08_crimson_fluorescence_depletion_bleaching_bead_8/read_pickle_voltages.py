...
def main():
    ...
    filename = 'voltages_green_960mW_red_0mW_phase.pickle'
    ...
    plt.figure()
    plt.plot(order1_voltages[0:200000, 1], '.-', label='Green AOM', color='green')
    plt.plot(order1_voltages[0:200000, 2], '.-', label='Red AOM', color='red')
    plt.plot(order1_voltages[0:200000, 0]/15, '.-', label='Camera trig', color='blue')
    plt.legend()
    plt.grid()
    plt.show()
